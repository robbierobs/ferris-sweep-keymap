...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_split_3x5_2(KC_ESCAPE, KC_MPLY, KC_MPRV, KC_MNXT, KC_UNDERSCORE, KC_MINUS, KC_7, KC_8, KC_9, KC_QUOT, KC_TAB, KC_NO, KC_KB_VOLUME_DOWN, KC_KB_VOLUME_UP, KC_PLUS, KC_EQUAL, KC_4, KC_5, KC_6, KC_ENTER, QK_RBT, KC_ASTERISK, KC_PGDN, KC_END, KC_DOT, KC_0, KC_1, KC_2, KC_3, TO(2), TO(0), KC_LCMD, KC_LALT, TO(1)),
	[4] = LAYOUT_split_3x5_2(KC_ESCAPE, KC_1, KC_2, KC_3, KC_4, KC_MINUS, KC_7, KC_8, KC_9, KC_BACKSPACE, KC_TAB, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENTER, KC_EQUAL, KC_4, KC_5, KC_6, KC_ENTER, KC_TRNS, KC_HOME, KC_PGDN, KC_END, KC_PGDN, KC_0, KC_1, KC_2, KC_3, KC_DOT, KC_HOME, KC_LALT, KC_LCTL, TO(0)),
